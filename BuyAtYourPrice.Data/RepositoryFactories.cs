...
namespace BuyAtYourPrice.Data
{
    ...
    {
        private IDictionary<Type, Func<DbContext, object>> GetBaypFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
                {
                    {typeof (IRepository<ProductCategory>), dbContext => new EfRepository<ProductCategory>(dbContext)}
                };
        }
        ...
        {
            _repositoryFactories = GetBaypFactories();
        }
